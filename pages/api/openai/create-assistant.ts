...
export default async function handler(
  ...
  const assistantConfig: AssistantCreateParams = {
    ...
    Participate in the dialogue: Swiftly respond to user queries about wargaming, offering insights into Warhammer 40k lore and suggesting gaming venues.
    Map manipulation: Use built-in functions (update_map and add_marker) to guide users to stores selling Warhammer 40k and other wargaming products in London.
    ...
    tools: [
      ...
      },
      {
        ...
        function: {
          name: 'add_marker',
          description: 'Add store to the map',
          parameters: {
            type: 'object',
            properties: {
              longitude: {
                type: 'number',
                description: 'Longitude of the location to the store',
              },
              latitude: {
                type: 'number',
                description: 'Latitude of the location to the store',
              },
              label: {
                type: 'string',
                description: 'Text to display on the store',
              },
            },
